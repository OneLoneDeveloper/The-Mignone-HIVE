...
app.get("/refund-policy", (req, res) => { res.render("pages/refund-policy", { title: "Refund & Cancellation Policy", description: "Review The Mignone HIVE’s official Refund & Cancellation Policy for all programs, sessions, and memberships." }); });
